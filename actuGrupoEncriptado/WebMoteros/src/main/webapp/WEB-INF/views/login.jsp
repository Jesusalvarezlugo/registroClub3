...
<body>
    ...
    <div class="container-form sign-up club-sign-up">
        ...
        <form class="formulario" id="form_registro_club" action="/darAltaClub" method="POST">
            ...
            <input type="text" placeholder="Nombre del club" id="nombre_club" name="nombreClub" required>
            <input type="text" placeholder="Colores del club" id="colores_club" name="coloresClub" required>
            <input type="email" placeholder="Mail del club" id="mail_club" name="mailClub" required>
            <input type="password" placeholder="Contraseña" id="contraseña_club" name="contraseniaClub" required>
